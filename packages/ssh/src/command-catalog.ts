...
export const COMMAND_CATALOG = [
  ...
  {
    arguments: [{ literal: 'inspect' }, { parameter: 'containerIds' }],
    executable: 'docker',
    id: 'docker.inspect-batch',
  ...
  },
  {
    ...
    executable: 'stat',
    id: 'directory.stat-batch',
    maxOutputBytes: 5_000_000,
    parameters: {
      paths: { kind: 'path_list', maxItems: 64, maxLength: 4096 },
    },
    requiredCommands: ['stat'],
    sudo: 'allowed',
    supportedDistributions: ALL_DISTRIBUTIONS,
